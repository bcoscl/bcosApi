 ...
 * @author aacantero
 */
public class ApiUpdateUsuarios extends ServerResource {

    private static final Logger Log = Logger.getLogger(ApiUpdateUsuarios.class);

    private ImplementacionJWT jwt = null;
    private Map s = new HashMap();
    private final String ERROR_TOKEN = "TOKEN_NO_VALIDO";

    public ApiUpdateUsuarios() {
        jwt = new ImplementacionJWT();
    }

    @Post
    public Representation updateUsuarios() {
